...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference("Ranking.count") do
      post rankings_url, params: { ranking: { hn: @ranking.hn, lexp: @ranking.lexp, mondai: @ranking.mondai, rexp: @ranking.rexp } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { hn: @ranking.hn, lexp: @ranking.lexp, mondai: @ranking.mondai, rexp: @ranking.rexp } }
